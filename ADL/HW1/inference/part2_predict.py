...
def main():
    ...
    part2_output = []
    progress = tqdm(total=len(prediction), position=0, leave=True)
    for i in range(len(prediction)):
        progress.update(1)
        part2_dict= {}
        part2_dict["id"] = raw_datasets["validation"][i]["id"]
        part2_dict["answer"] = prediction[i]["prediction_text"]
        part2_output.append(part2_dict)
    progress.close()
    
    

    # 使用 os.path.dirname() 提取目錄位置
    folder_path = os.path.dirname(args.csv_path)
